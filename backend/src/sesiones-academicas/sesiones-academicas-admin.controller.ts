...
@ApiTags('Sesiones Académicas (Admin)')
@UseGuards(JwtAuthGuard, RolesGuard)
@Roles('Coordinador', 'Super Usuario')
@ApiBearerAuth()
@Controller('admin/sesiones-academicas')
export class SesionesAcademicasAdminController {
  ...
  @ApiOperation({ summary: 'Generar PIN de asistencia (Coordinador)' })
